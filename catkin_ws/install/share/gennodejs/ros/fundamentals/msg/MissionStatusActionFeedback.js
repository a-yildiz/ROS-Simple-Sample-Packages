...
let MissionStatusFeedback = require('./MissionStatusFeedback.js');
let std_msgs = _finder('std_msgs');
let actionlib_msgs = _finder('actionlib_msgs');

//-----------------------------------------------------------

class MissionStatusActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new MissionStatusFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = MissionStatusFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MissionStatusActionFeedback(null);
    ...
    data.feedback = MissionStatusFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += MissionStatusFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MissionStatusActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = MissionStatusFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new MissionStatusFeedback()
    }
...
module.exports = MissionStatusActionFeedback;
