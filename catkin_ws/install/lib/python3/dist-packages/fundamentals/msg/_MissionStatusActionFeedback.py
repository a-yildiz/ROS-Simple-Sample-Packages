...
"""autogenerated by genpy from fundamentals/MissionStatusActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class MissionStatusActionFeedback(genpy.Message):
  _md5sum = "6f5cd22a9d66e27e95e7880a3220991d"
  _type = "fundamentals/MissionStatusActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','fundamentals/MissionStatusFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MissionStatusActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = fundamentals.msg.MissionStatusFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = fundamentals.msg.MissionStatusFeedback()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.feedback.ratio = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.feedback.ratio = str[start:end]
      return self
